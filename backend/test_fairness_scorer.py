...
try:
    ...
    print("\nStep 3: Running missing clause detection...")
    ...
    print("\nStep 4: Running fairness scoring...")
    scoring_result = score_fairness(state)
    state["fairness_score"] = scoring_result["fairness_score"]
    state["score_breakdown"] = scoring_result["score_breakdown"]
    state["fairness_reasoning"] = scoring_result["fairness_reasoning"]
    state["overall_assessment"] = scoring_result["overall_assessment"]
    print("Fairness scoring completed!")
